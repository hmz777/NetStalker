...
namespace NetStalker.TestingArea.ToastNotifications
{
    public class NotificationAPI
    {
        ...
        public void CreateAndShowMessage(string message)
        {
            ...
            DesktopNotifications.DesktopNotificationManagerCompat.CreateToastNotifier().Show(messageNotification);
        }
        ...
        public void CreateAndShowPrompt(string message)
        {
            ...
            DesktopNotifications.DesktopNotificationManagerCompat.CreateToastNotifier().Show(promptNotification);
        }
        ...
        public static void RemoveNotification(string tag)
        {
            ...
            DesktopNotifications.DesktopNotificationManagerCompat.History.Remove(tag);
        }
